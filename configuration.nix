...

{
  ...
  boot.initrd.luks.devices."luks-ba2ceb06-59aa-44bb-ba8a-69a39cd36e1c".device = "/dev/disk/by-uuid/ba2ceb06-59aa-44bb-ba8a-69a39cd36e1c";
  networking.hostName = "steve-nix"; # Define your hostname.
